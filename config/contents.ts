...
export const productsFaq = [
  {
    question: "How does Unblur.photos work?",
    answer:
      "Unblur.photos uses AI to enhance images. You upload an image, select the type of enhancement you want to apply, and the AI will enhance your image. The enhanced image is then displayed to you to download or share."
  },
  {
    question: "What types of enhancements can I apply to my image?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Credits are used to enhance images. Subscriptions are a recurring payment that allows you to purchase credits at a discounted rate. One-time credits packs are one-time purchases that do not renew."
  },
  {
    question: "How do I cancel my subscription?",
    answer:
      "You can cancel your subscription at any time. You can do this by going to your Accounts page and clicking the 'Manage Account' button."
  },
  {
    question: "How many credits do I get with a subscription?",
    answer:
      "The number of credits you get with a subscription depends on the subscription tier you choose. You can find more information about the different subscription tiers and the number of credits they include on the subscription page."
  },
  {
    question: "What image formats do you support?",
    answer:
      "We support JPG, JPEG, and PNG image formats. We do not support HEIC images, SVG and animated images for now."
  },
  {
    question: "Does my purchase expire?",
    answer:
      "Credits purchased via subscriptions will expire at the end of the month with new credits added at the beginning of the next month. Credits purchased via one-time credits packs will not expire."
  },
  {
